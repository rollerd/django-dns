...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subnet.proper_name'
        db.add_column(u'pdns_subnet', 'proper_name',
                      self.gf('django.db.models.fields.CharField')(default='TEMP', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subnet.proper_name'
        db.delete_column(u'pdns_subnet', 'proper_name')
